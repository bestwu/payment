...
public class AlipaySignature {
   ...
   * sign_type=RSA, <br>charset=UTF-8 <br>} </p>
   *
   ...
   * @return 加密、签名后xml内容字符串 <p> 返回示例： <alipay> <response>密文</response> <encryption_type>RSA</encryption_type>
   * <sign>sign</sign> <sign_type>RSA</sign_type> </alipay> </p>
   */
