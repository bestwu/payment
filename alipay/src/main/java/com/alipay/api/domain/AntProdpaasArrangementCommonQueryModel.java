...
public class AntProdpaasArrangementCommonQueryModel extends AlipayObject {
  ...
  public void setArrangementConditionGroupSelector(
      ArrangementConditionGroupSelector arrangementConditionGroupSelector) {
  ...
  public void setArrangementInvolvedPartyQuerier(
      ArrangementInvolvedPartyQuerier arrangementInvolvedPartyQuerier) {
