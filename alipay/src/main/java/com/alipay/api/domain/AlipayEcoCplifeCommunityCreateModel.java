...
public class AlipayEcoCplifeCommunityCreateModel extends AlipayObject {
   ...
   *
   * 经纬度是小区搜索和用户推广的重要参数，录入时请确保经纬度参数准确。 高德经纬度查询：<a href="http://lbs.amap.com/console/show/picker">人工方式</a>|<a
   * href="http://lbs.amap.com/api/webservice/guide/api/search/">接口方式</a> 坐标系转换：<a
   * href="http://lbs.amap.com/api/webservice/guide/api/convert/">查看接口文档</a>
   */
